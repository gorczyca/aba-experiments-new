...
#SBATCH --job-name=DC_TC_BFS_s3b_normal_1_1
...
EXPERIMENT_NAME="DC_TC_BFS_s3b_normal_1_1_exp"
TIMEOUT=1200

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode normal --one 1 --dfs 0 --tc TC --da xDAx --swa 1 --ordering pb2pf2pb1ob2of2ob1pf1 --prc smin --orc smin --phc l --ohc l --propP 1 --oppP 1
