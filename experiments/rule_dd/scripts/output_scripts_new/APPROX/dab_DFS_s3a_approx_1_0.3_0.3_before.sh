...
#SBATCH --job-name=2_dab_DFS_s3a_approx_1_0.3_0.3_before
...
EXPERIMENT_NAME="2_dab_DFS_s3a_approx_1_0.3_0.3_before_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 1 --tc TA --da dab --swa 0 --ordering pf1pb2pf2pb1ob2of2ob1 --prc smax --orc smax --phc m --ohc m --propP 0.3 --oppP 0.3 --sampleBefore 1
