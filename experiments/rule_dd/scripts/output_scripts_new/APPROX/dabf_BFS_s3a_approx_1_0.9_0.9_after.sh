...
#SBATCH --job-name=2_dabf_BFS_s3a_approx_1_0.9_0.9_after
...
EXPERIMENT_NAME="2_dabf_BFS_s3a_approx_1_0.9_0.9_after_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 0 --tc TA --da dabf --swa 0 --ordering pf1pb2pf2pb1ob2of2ob1 --prc smax --orc smax --phc m --ohc m --propP 0.9 --oppP 0.9 --sampleBefore 0
