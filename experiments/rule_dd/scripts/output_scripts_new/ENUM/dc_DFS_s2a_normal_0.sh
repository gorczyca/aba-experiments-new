...
EXPERIMENT_NAME="2_dc_DFS_s2a_normal_0_exp"
TIMEOUT=1800

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode normal --one 0 --dfs 1 --tc TA --da dc --swa 0 --ordering pf1ob1ob2of2pb1pb2pf2 --prc smax --orc smax --phc m --ohc m --propP 1 --oppP 1
