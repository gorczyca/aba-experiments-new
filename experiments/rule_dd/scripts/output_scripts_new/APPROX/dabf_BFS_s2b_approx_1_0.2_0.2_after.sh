...
#SBATCH --job-name=2_dabf_BFS_s2b_approx_1_0.2_0.2_after
...
EXPERIMENT_NAME="2_dabf_BFS_s2b_approx_1_0.2_0.2_after_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 0 --tc TA --da dabf --swa 0 --ordering ob1ob2of2pb1pb2pf2pf1 --prc smin --orc smin --phc l --ohc l --propP 0.2 --oppP 0.2 --sampleBefore 0
