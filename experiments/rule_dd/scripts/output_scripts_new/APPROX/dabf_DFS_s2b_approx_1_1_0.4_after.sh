...
#SBATCH --job-name=2_dabf_DFS_s2b_approx_1_1_0.4_after
...
EXPERIMENT_NAME="2_dabf_DFS_s2b_approx_1_1_0.4_after_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 1 --tc TA --da dabf --swa 0 --ordering ob1ob2of2pb1pb2pf2pf1 --prc smin --orc smin --phc l --ohc l --propP 1 --oppP 0.4 --sampleBefore 0
