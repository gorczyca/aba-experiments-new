...
#SBATCH --job-name=2_dab_DFS_s1_approx_1_1_0.7_after
...
EXPERIMENT_NAME="2_dab_DFS_s1_approx_1_1_0.7_after_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 1 --tc TA --da dab --swa 0 --ordering pf1pb1ob2of2ob1pb2pf2 --prc l1s --orc l1s --phc r --ohc r --propP 1 --oppP 0.7 --sampleBefore 0
