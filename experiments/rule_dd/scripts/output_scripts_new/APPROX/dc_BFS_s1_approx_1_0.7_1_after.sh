...
#SBATCH --job-name=2_dc_BFS_s1_approx_1_0.7_1_after
...
EXPERIMENT_NAME="2_dc_BFS_s1_approx_1_0.7_1_after_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 0 --tc TA --da dc --swa 0 --ordering pf1pb1ob2of2ob1pb2pf2 --prc l1s --orc l1s --phc r --ohc r --propP 0.7 --oppP 1 --sampleBefore 0
