...
#SBATCH --job-name=2_dab_BFS_s2b_approx_1_1_0.9_before
...
EXPERIMENT_NAME="2_dab_BFS_s2b_approx_1_1_0.9_before_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 0 --tc TA --da dab --swa 0 --ordering ob1ob2of2pb1pb2pf2pf1 --prc smin --orc smin --phc l --ohc l --propP 1 --oppP 0.9 --sampleBefore 1
