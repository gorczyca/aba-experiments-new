...
#SBATCH --job-name=2_DC_TC_BFS_s1_pref_1_1
...
EXPERIMENT_NAME="2_DC_TC_BFS_s1_pref_1_1_exp"
TIMEOUT=1200

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode pref --one 1 --dfs 0 --tc TC --da DC --swa 1 --ordering pf1pb1ob2of2ob1pb2pf2 --prc l1s --orc l1s --phc r --ohc r --propP 1 --oppP 1 --sampleBefore 1
