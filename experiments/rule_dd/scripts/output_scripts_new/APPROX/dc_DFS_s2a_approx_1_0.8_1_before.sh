...
#SBATCH --job-name=2_dc_DFS_s2a_approx_1_0.8_1_before
...
EXPERIMENT_NAME="2_dc_DFS_s2a_approx_1_0.8_1_before_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 1 --tc TA --da dc --swa 0 --ordering pf1ob1ob2of2pb1pb2pf2 --prc smax --orc smax --phc m --ohc m --propP 0.8 --oppP 1 --sampleBefore 1
