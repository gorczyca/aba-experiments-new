...
#SBATCH --job-name=2_dab_DFS_s2_approx_1_0.9_1_before
...
EXPERIMENT_NAME="2_dab_DFS_s2_approx_1_0.9_1_before_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 1 --tc TA --da dab --swa 0 --ordering pf1ob1ob2of2pb1pb2pf2 --prc smin --orc smin --phc l --ohc l --propP 0.9 --oppP 1 --sampleBefore 1
