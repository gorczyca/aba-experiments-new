...
#SBATCH --job-name=2_dab_BFS_s2a_approx_1_0.8_0.8
...
EXPERIMENT_NAME="2_dab_BFS_s2a_approx_1_0.8_0.8_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 0 --tc TA --da dab --swa 0 --ordering pf1ob1ob2of2pb1pb2pf2 --prc smax --orc smax --phc m --ohc m --propP 0.8 --oppP 0.8
