...
INPUTS_PATH = 'C:\\Users\\User\\AppData\\Local\\Packages\\CanonicalGroupLimited.Ubuntu20.04onWindows_79rhkp1fndgsc\\LocalState\\rootfs\\home\\piotrek\\partial_output\\outputs\\*'
...
if __name__ == '__main__':
    ...
    for dir in directories:
        ...
        df.to_csv(f'{OUTPUTS_PATH}/{setup_name}.csv', index=True)
