...
#SBATCH --job-name=2_DS_TS_BFS_s2b_normal_1_1
...
EXPERIMENT_NAME="2_DS_TS_BFS_s2b_normal_1_1_exp"
TIMEOUT=1200

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode normal --one 1 --dfs 0 --tc TS --da DS --swa 1 --ordering ob1ob2of2pb1pb2pf2pf1 --prc smin --orc smin --phc l --ohc l --propP 1 --oppP 1 --sampleBefore 1
