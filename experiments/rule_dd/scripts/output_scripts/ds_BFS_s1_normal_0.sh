...
srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode normal --one 0 --dfs 0 --tc TA --da ds --swa 0 --ordering pf1pb1ob2of2ob1pb2pf2 --prc l1 --orc l1 --phc r --ohc r --propP 1 --oppP 1
