...
#SBATCH --job-name=2_dabf_BFS_s3b_approx_1_0.5_0.5_before
...
EXPERIMENT_NAME="2_dabf_BFS_s3b_approx_1_0.5_0.5_before_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 0 --tc TA --da dabf --swa 0 --ordering pb2pf2pb1ob2of2ob1pf1 --prc smin --orc smin --phc l --ohc l --propP 0.5 --oppP 0.5 --sampleBefore 1
