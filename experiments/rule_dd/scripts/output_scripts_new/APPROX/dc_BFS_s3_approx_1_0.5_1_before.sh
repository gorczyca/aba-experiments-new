...
#SBATCH --job-name=2_dc_BFS_s3_approx_1_0.5_1_before
...
EXPERIMENT_NAME="2_dc_BFS_s3_approx_1_0.5_1_before_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 0 --tc TA --da dc --swa 0 --ordering pf1pb2pf2pb1ob2of2ob1 --prc smin --orc smin --phc l --ohc l --propP 0.5 --oppP 1 --sampleBefore 1
