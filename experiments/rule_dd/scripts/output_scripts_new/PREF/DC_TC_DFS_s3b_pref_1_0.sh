...
#SBATCH --job-name=2_DC_TC_DFS_s3b_pref_1_0
...
EXPERIMENT_NAME="2_DC_TC_DFS_s3b_pref_1_0_exp"
TIMEOUT=1200

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode pref --one 1 --dfs 1 --tc TC --da DC --swa 0 --ordering pb2pf2pb1ob2of2ob1pf1 --prc smin --orc smin --phc l --ohc l --propP 1 --oppP 1 --sampleBefore 1
