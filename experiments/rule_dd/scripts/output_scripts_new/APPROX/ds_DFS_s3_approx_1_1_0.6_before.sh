...
#SBATCH --job-name=2_ds_DFS_s3_approx_1_1_0.6_before
...
EXPERIMENT_NAME="2_ds_DFS_s3_approx_1_1_0.6_before_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 1 --tc TA --da ds --swa 0 --ordering pf1pb2pf2pb1ob2of2ob1 --prc smin --orc smin --phc l --ohc l --propP 1 --oppP 0.6 --sampleBefore 1
