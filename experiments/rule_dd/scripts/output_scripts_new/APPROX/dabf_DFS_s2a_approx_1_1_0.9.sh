...
#SBATCH --job-name=2_dabf_DFS_s2a_approx_1_1_0.9
...
EXPERIMENT_NAME="2_dabf_DFS_s2a_approx_1_1_0.9_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 1 --tc TA --da dabf --swa 0 --ordering pf1ob1ob2of2pb1pb2pf2 --prc smax --orc smax --phc m --ohc m --propP 1 --oppP 0.9
