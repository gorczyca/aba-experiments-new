...
#SBATCH --job-name=DC_TC_DFS_s2a_normal_1_0
...
EXPERIMENT_NAME="DC_TC_DFS_s2a_normal_1_0_exp"
TIMEOUT=1200

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode normal --one 1 --dfs 1 --tc TC --da xDAx --swa 0 --ordering pf1ob1ob2of2pb1pb2pf2 --prc smax --orc smax --phc m --ohc m --propP 1 --oppP 1
