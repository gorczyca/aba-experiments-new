...
#SBATCH --job-name=2_dc_BFS_s3b_approx_1_1_0.4_before
...
EXPERIMENT_NAME="2_dc_BFS_s3b_approx_1_1_0.4_before_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 0 --tc TA --da dc --swa 0 --ordering pb2pf2pb1ob2of2ob1pf1 --prc smin --orc smin --phc l --ohc l --propP 1 --oppP 0.4 --sampleBefore 1
