...
#SBATCH --job-name=2_DS_TS_DFS_s3a_normal_1_1
...
EXPERIMENT_NAME="2_DS_TS_DFS_s3a_normal_1_1_exp"
TIMEOUT=1200

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode normal --one 1 --dfs 1 --tc TS --da DS --swa 1 --ordering pf1pb2pf2pb1ob2of2ob1 --prc smax --orc smax --phc m --ohc m --propP 1 --oppP 1 --sampleBefore 1
