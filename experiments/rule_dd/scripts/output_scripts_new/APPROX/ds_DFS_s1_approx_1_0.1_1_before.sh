...
#SBATCH --job-name=2_ds_DFS_s1_approx_1_0.1_1_before
...
EXPERIMENT_NAME="2_ds_DFS_s1_approx_1_0.1_1_before_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 1 --tc TA --da ds --swa 0 --ordering pf1pb1ob2of2ob1pb2pf2 --prc l1s --orc l1s --phc r --ohc r --propP 0.1 --oppP 1 --sampleBefore 1
