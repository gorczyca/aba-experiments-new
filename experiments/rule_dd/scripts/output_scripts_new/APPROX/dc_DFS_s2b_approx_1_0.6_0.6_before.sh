...
#SBATCH --job-name=2_dc_DFS_s2b_approx_1_0.6_0.6_before
...
EXPERIMENT_NAME="2_dc_DFS_s2b_approx_1_0.6_0.6_before_exp"
TIMEOUT=600

srun --exclusive --ntasks=1 python $PYTHON_SCRIPT_LOC $CSV_LOC $INSTANCES_DIR_LOC $EXPERIMENT_NAME $TIMEOUT -i apx --mode approx --one 1 --dfs 1 --tc TA --da dc --swa 0 --ordering ob1ob2of2pb1pb2pf2pf1 --prc smin --orc smin --phc l --ohc l --propP 0.6 --oppP 0.6 --sampleBefore 1
